  ...
  render() {
    return(
      <ul className="nav nav-tabs card-header-tabs" role="tablist">
        ...
        <li className="nav-item">
          <a className={this.state.active === 'html5' ? "nav-link active" : "nav-link"} aria-selected={this.state.active === 'html5' ? "true" : "false"} role="tab" aria-controls="html 5" href="/html5" onClick={(e) => this.handleClick(e, 'html5')}>HTML 5 + Aria</a>
        </li>
        <li className="nav-item">
